...
class SliderController extends Controller
{
    ...
    private $bread_main = 'Sliders';
    private $bread_desc_index = 'Sliders';
    private $bread_desc_edit = 'Edit Slider';
    private $bread_desc_create = 'Add Slider';
    ...
    public function insert($request, &$model, $mod='create')
    {
        ...
        if(($model->by_ocoda_dev == null || $model->by_ocoda_dev == false) && $mod == 'edit') {
            if($request->image){
                ...
                @unlink(public_path('uploads/slider/'.$model->image));
    ...
    {
        $request->validate(array_merge($this->valid($request), (new ImageService(new Slider()))->getImageValidationRules(), (new SEOToolsService)->getSEOToolsValidationRules()),[], $this->attrs());
    ...
    public function update(Request $request, $id)
    {
        ...
        if($result->by_ocoda_dev == true) {
            $request->validate(array_merge($this->valid($request, 'edit'), (new ImageService(new Slider))->getImageDetailsValidationRules(), (new SEOToolsService)->getSEOToolsValidationRules()),[], $this->attrs());
        } else {
