...
class InvestmentsGroupController extends Controller
{
    private $route = 'igroups';
    private $model = Igroup::class;
    private $bread_main = 'Investments Groups';
    private $bread_desc_index = 'Investments Groups';
    private $bread_desc_edit = 'Edit Group';
    private $bread_desc_create = 'Add Group';
