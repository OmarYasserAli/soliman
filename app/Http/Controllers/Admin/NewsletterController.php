...
{
    private $route = 'newsletters';
    private $model = Newsletter::class;
    private $bread_main = 'newsletters';
    private $bread_desc_index = 'newsletters';
    private $bread_desc_edit = 'Edit Newsletter';
    private $bread_desc_create = 'Add Newsletter';
