...
{
    private $route = 'sellers';
    private $model = Seller::class;
    private $bread_main = 'Sellers';
    private $bread_desc_index = 'Sellers';
    private $bread_desc_edit = 'Edit Seller';
    private $bread_desc_create = 'Add Seller';
    ...
    public function valid($request, $mod='create')
    {
        $v = [
            ...
            'password' => $mod== 'create' ? 'required' : 'nullable',
        ];
        return $v;
    }
    ...
    public function insert($request, &$model, $mod='create')
    {
        ...
        if($mod == 'create' || $request->has('password')){
            $model->password = Hash::make($request->password);
        }
        $model->active = (boolean)$request->active;
    }
