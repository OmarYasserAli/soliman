$(function () {
    ...
    $(window).ready(i),
        ...
        $(function () {
            if($(window).width() <= 1500 && !$("body").hasClass("mini-sidebar")){
        ...
        $(".right-side-icon").click(function () {
        ...
        (function (i, e, s) {
            ...
            i(o).each(function () {
                var e = i(this),
                    ...
                    o = s.find(".card-block"),
                    r = { toggle: !1 };
                o.length || ((o = s.children(".card-heading").nextAll().wrapAll("<div/>").parent().addClass("card-block")), (r = {})),
                    o
                        .collapse(r)
