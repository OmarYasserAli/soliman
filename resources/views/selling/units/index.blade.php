            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $result->name }}</td>
                        <td><a href="{{route('units.index')}}?project_id={{ @$result->project_id }}">{{ @$result->project->name->en }}</a></td>
                        <td class="text-nowrap">
                            <a onclick="return confirm('Are Youe Sure?')" href="{{ route($route . '.replicate', $result->id) }}" data-toggle="tooltip" data-original-title="Replicate"> <i class="fa fa-copy text-inverse m-r-10"></i> </a>
                            <a onclick="return confirm('Are Youe Sure?')" href="{{ route($route . '.replicate10', $result->id) }}" data-toggle="tooltip" data-original-title="Replicate 10 Times"> <i class="fa fa-percent text-inverse m-r-10"></i> </a>
