            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $result->title->en }}</td>
                        <td class="text-nowrap">
                            <a href="{{ route('pageBySlug', $result->slug) }}" target="_blank" data-toggle="tooltip" data-original-title="View"> <i class="fa fa-eye text-inverse m-r-10"></i> </a>
