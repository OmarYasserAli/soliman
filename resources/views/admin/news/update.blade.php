                ...
                @if(@$update) @method('PUT') @endif
                  <div class="form-body">
                      ...
                      <div class="row p-t-20">
                        @foreach ( (new App\Models\News)->getModelUniqueImageToFormInputNames() as $key)
                            @include('enhance.admin.partials._imageDetails', ['key' => $key])
                        @endforeach

                        @if ((new App\Models\News)->hasSeoTools)
                        ...
                        <div class="col-md-12">
                            <x-textarea title="Content" tcalss=".editor" name="content" arval="{!! @$result->content->ar !!}" enval="{!! @$result->content->en !!}" />
                        </div>
                    </div><!--/row-->
