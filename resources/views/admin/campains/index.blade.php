            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $result->title}}</td>
                        <td>{!! $result->active ? '<span class="label label-success">Yes</span>' : '<span class="label label-danger">No</span>' !!} </td>

                        <td class="text-nowrap">
                            <a href="{{ route('campain', $result->slug) }}" target="_blank" data-toggle="tooltip" data-original-title="View"> <i class="fa fa-eye text-inverse m-r-10"></i> </a>
